    ...
    public static void main(String[] args) {
        ...
        while (right < 5) {
            ...
            if (selected < 0 || selected > 99) {
                System.out.println("Lutfen 0-100 arasinda bir değer giriniz.");
                if (isWrong) {
                    right++;
                    System.out.println("Çok fazla hatali giriş yaptiniz. Kalan hak : " + (5 - right));
                } else {
                    isWrong = true;
                    System.out.println("Bir daha hatali girişinizde hakkinizdan dusulecektir.");
                }
                continue;
            }
